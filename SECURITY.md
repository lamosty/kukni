...
The standalone app does not yet route image or camera RAW content to a rich
renderer. The bounded CR2 extractor remains available to future standalone
renderer work, but no GNOME Sushi plugin integration ships with Kukni.
